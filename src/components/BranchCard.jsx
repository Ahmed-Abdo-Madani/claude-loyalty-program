    ...
    <div className="card-compact bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
      ...
      <div className="flex items-center justify-between gap-3 mb-3 px-2 py-2 bg-gray-50 dark:bg-gray-900/20 rounded-lg">
        <div className="flex-1 text-center border-r border-gray-200 dark:border-gray-700 last:border-0">
          ...
          <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">Customers</div>
        </div>
        <div className="flex-1 text-center border-r border-gray-200 dark:border-gray-700 last:border-0">
          <div className="text-base sm:text-lg font-bold text-primary">
            {branch.activeOffers || 0}
          </div>
          <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">Offers</div>
        </div>
        <div className="flex-1 text-center">
          ...
          <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">Monthly</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          {/* Duplicate Button - Icon only on mobile */}
          <button
          ...
          >
            ...
            <span className="hidden sm:inline font-medium">Duplicate</span>
          </button>
        </div>
