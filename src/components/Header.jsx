      ...
      <div className="container-max section-padding">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/demo"
              className="hidden md:block text-sm font-medium text-primary dark:text-blue-400 hover:text-primary-dark transition-colors"
            >
              {t('header.tryDemo')}
            </Link>
            <div className="h-6 w-px bg-gray-200 dark:bg-slate-700 mx-1 hidden md:block"></div>
            ...
            <Link
              ...
              className="hidden md:inline-flex btn-primary text-sm py-2 px-4 shadow-lg shadow-primary/20 hover:shadow-primary/40"
            >
