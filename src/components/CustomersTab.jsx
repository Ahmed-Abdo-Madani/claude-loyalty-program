        ...
        <div className="mt-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex gap-4">
            <button
              ...
              className={`px-4 py-2 font-medium transition-colors border-b-2 ${activeTab === 'customers'
              ...
              <div className="space-y-3 mb-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap min-h-[36px] touch-manipulation ${filterStatus === 'all'
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap min-h-[36px] touch-manipulation ${filterStatus === 'vip'
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap min-h-[36px] touch-manipulation ${filterStatus === 'inactive'
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap min-h-[36px] touch-manipulation ${filterStatus === 'churning'
                ...
                <tbody>
                  {paginatedCustomers.map((customer, index) => (
                    <tr
                      ...
                      className={`border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 ${index === paginatedCustomers.length - 1 ? 'border-b-0' : ''
                        }`}
                    >
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-2 min-h-[44px] rounded-lg border transition-colors ${currentPage === pageNum
